...
/*   Updated: 2025/02/24 09:20:04 by nmorgado         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "get_next_line.h"

static int	ifrest(char **rest, char **ret_string, int i)
{
	i = 0;
...
static int	whileread_resul(char *read_resul, int *i, char *ret_string,
	char **rest)
{
	int	bool;
...
static int	whilebool2(char **read_resul, char **ret_string, char **rest,
	int *bool)
{
	int	temp_bool;
	int	i;
...
static char	*whilebool(char **read_resul, char **ret_string, int fd,
	char **rest)
{
	int		bool;
